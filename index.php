...
var b = document.forms["form"]["cpassword"].value;if (a!=b){alert("Passwords must match.");return false;}var phone = document.forms["form"]["mob"].value;if(isNaN(phone)){alert("Enter Valid Mobile");return false;}}
</script>
<body>
...
<a href="#" data-toggle="modal" data-target="#login"><center>Admin Login</center></a></div>
<div class="col-md- box">
<a href="#"  data-toggle="modal" data-target="#myModal"><center>Sign In</center></a></div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="mob" name="mob" placeholder="Enter your mobile number" class="form-control input-md" type="text" maxlength="10" required>
